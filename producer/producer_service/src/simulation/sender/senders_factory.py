...
class SenderFactory:
    ...
    def create_app_log_sender(source:str, serializer_factory: ISerializerFactory, kafka_producer: Producer, results: Results) -> Sender:
        return Sender(
    ...
    def create_access_log_sender(source: str, serializer_factory: ISerializerFactory, kafka_producer: Producer, results: Results) -> Sender:
        return Sender(
    ...
    def create_metrics_sender(source: str, serializer_factory: ISerializerFactory, kafka_producer: Producer, results:Results) -> Sender:
        return Sender(
